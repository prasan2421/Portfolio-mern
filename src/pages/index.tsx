...
const objectData = [
  ...
  { 'id': '2', 'img': 'images/spoiq.png', 'title': 'Video Highlighter', 'subtitle': 'A mobile application to capture real-time highlights and edit highlights.', 'technologies': 'React Native, Typescript, Express, MongoDB, React Native Paper, Redux', 'link':'', 'date': '07/05/2018 – Ongoing', 'list': ['A cross platform React Native mobile application.','- Video recording.',
  '- Capturing highlights from different categories.',
  '- Add or edit highlights from the pre recorded videos/ highlights. etc.',
  ], 'images': ['/images/spoiq6.png','/images/spoiq6.png'] },
...
export default function Home(props) {
  ...
  {data?(
   ...
   {error?(
    ...
    <Box className='subTitle'><Typography  variant="subtitle1">React | React Native | Node | JS / TS | C# | <Box className='subTitleUIUX'> UI / UX</Box></Typography></Box>
